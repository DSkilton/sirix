...
public final class Modification {
     ...
     * Constructor.
     *
     * @param pModifications number of modifications in the subtree
     * @param pDescendants number of descendants in the subtree
     * @param pSubtract determines if modifications must be subtracted
     */
