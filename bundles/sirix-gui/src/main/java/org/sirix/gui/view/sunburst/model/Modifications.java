...
public final class Modifications extends RecursiveTask<Modification> implements
    ...
    /**
     * {@link List} of {@link DiffTuple}s which is needed to count deleted
     * nodes.
     */
     ...
     *
     * @param paramIndex current index in diff list
     * @param paramDiffs {@link List} of {@link DiffTuple}s
     * @throws IllegalArgumentException if {@code paramIndex <= -1}
     * @throws NullPointerException if {@code paramDiffs} is {@code null}
     * @return {@link Modifications} reference
     * @throws SirixException if anything inside sirix fails
     */
     ...
     *
     * @param paramIndex index of diff to get
     * @param paramDiffCounts diff counter
    ...
    /**
     * Count how many differences in the subtree exists and add
     * descendant-or-self count.
     *
     * @return number of differences and descendants
     * @throws SirixException if sirix can't close the transaction
     */
