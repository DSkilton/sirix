...
final class SunburstListContainer implements Comparator<SunburstListContainer>,
     ...
     * Constructor.
     *
     * @param pMaxDepth maximum depth
     * @param pOldMaxDepth maximum depth of older revision
     * @param pItems {@link List} of {@link SunburstItem}s
     * @param pRevision current revision
     */
