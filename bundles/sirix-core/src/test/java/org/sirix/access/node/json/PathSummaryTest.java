...
public class PathSummaryTest {
    ...
    public void testInsertTestDocument() {
        try (final var database = JsonTestHelper.getDatabase(JsonTestHelper.PATHS.PATH1.getFile()); final var manager = database.openResourceManager(JsonTestHelper.RESOURCE); final var pathSummary = manager.openPathSummary()) {
