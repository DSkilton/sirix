...
public final class Levenshtein {
    ...
    /**
     * Gets the similarity of the two strings using levenstein distance if
     * string lengths are between {@link Levenshtein#MIN} and
     * {@link Levenshtein#MAX}. Otherwise string equality is used whereas
     * {@code 0} is returned if the strings aren't equal and {@code 1} if they
     * are equal.
     *
     * @param first first string
     * @param second second string
     * @return a value between {@code 0} and {@code 1}. {@code 0} denotes that
     * the strings are completely different, {@code 1} denotes that the strings
     * are equal
     * @throws NullPointerException if {@code pFirst} or {@code pSecond} is
     * {@code null}
     */
