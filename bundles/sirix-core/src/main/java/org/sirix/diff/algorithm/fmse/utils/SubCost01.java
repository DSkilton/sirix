 ...
 * between String Data. All metrics return consistant measures rather than
 * unbounded similarity scores.
 *
 * Copyright (C) 2005 Sam Chapman - Open Source Release v1.1
 *
 * Please Feel free to contact me about this library, I would appreciate knowing
 * quickly what you wish to use it for and any criticisms/comments upon the
 * SimMetric library.
 *
 * email: s.chapman@dcs.shef.ac.uk www: http://www.dcs.shef.ac.uk/~sam/ www:
 * http://www.dcs.shef.ac.uk/~sam/stringmetrics.html
 *
 * address: Sam Chapman, Department of Computer Science, University of
 * Sheffield, Sheffield, S. Yorks, S1 4DP United Kingdom,
 *
