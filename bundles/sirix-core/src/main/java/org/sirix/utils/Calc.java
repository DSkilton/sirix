...
public final class Calc {
    ...
    /**
     * Nulls in this project are viewed as EOF, thus it is often of interest
     * when comparing two values which one is greatest to check if one is null
     * or possible both and return which.
     *
