...
public interface Axis extends PeekingIterator<Long>, Iterable<Long>, SirixAxis {
     ...
     * @throws ClassCastException if the node cursor is no
     * {@link XmlNodeReadOnlyTrx}
     */
    XmlNodeReadOnlyTrx asXdmNodeReadTrx();

    /**
     * Foreach-iterator calling a {@link org.sirix.api.visitor.NodeVisitor} for
     * each iteration.
     *
