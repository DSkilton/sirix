...
public class BinaryComparables {
    ...
    /**
     * Uses {@link String#getBytes(Charset)} to get bytes in the lexicographic
     * order of Unicode code points, as defined in
     * {@link String#compareTo(String)} <br>
     * Note: Use Collators if you want locale dependent comparisons
     *
     * @see
     * <a href="https://docs.oracle.com/javase/tutorial/i18n/text/collationintro.html">Collator</a>
     */
