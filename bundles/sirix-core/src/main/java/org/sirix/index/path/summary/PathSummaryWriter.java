...
public final class PathSummaryWriter<R extends NodeCursor & NodeReadOnlyTrx>
    ...
    public enum OPType {
        ...
        MOVED_ON_SAME_LEVEL,
        /**
         * Move from and to is not on the same level (before and after the move,
         * the node has a different parent).
         */
        MOVED,
        /**
     ...
     * @param name the new {@link QName} in case of a new one is set, the old
    ...
    /**
     * Move path summary to the associated {@code parent} {@link PathNode} and
