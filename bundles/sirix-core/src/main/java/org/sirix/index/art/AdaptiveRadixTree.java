...
/**
 * An Adaptive Radix tree based {@link NavigableMap} implementation. The map is
...
public class AdaptiveRadixTree<K, V> extends AbstractMap<K, V> implements NavigableMap<K, V> {
    ...
    /**
     * The number of structural modifications to the tree. To be touched where
     * ever size changes.
     */
     ...
     *
     * @throws NoSuchElementException if the Entry is null Note: taken from
     * TreeMap
     */
